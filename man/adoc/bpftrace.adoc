...
The last variant `fentry:bpf:prog_name` allows attaching to running BPF programs and sub programs.
You can see a list of running BPF programs and sub programs with `bpftrace -l 'fentry:bpf:*'`.
