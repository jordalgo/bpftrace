...
// Recursive descent parser for bpftrace programs.
//
// This is an alternative to the flex/bison-based parser. It produces the
// same AST nodes so subsequent passes work unchanged.
class RDParser {
public:
